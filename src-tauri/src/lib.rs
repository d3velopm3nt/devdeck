...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            mail::mail_contact_messages,
            mail::mail_attachments_default,
            mail::mail_labels,
            mail::mail_sync_label,
            // The learn run: the estimate is local, the run is the one place
            // mail leaves the machine, and the rest decide what it found.
            aiw::learn::learn_estimate,
            aiw::learn::learn_people,
            aiw::learn::learn_run,
            ...
            aiw::learn::learn_runs,
            aiw::learn::learn_facts,
            aiw::learn::learn_keep,
            aiw::learn::learn_decline,
            ...
            aiw::commands::aiw_remember,
            aiw::commands::aiw_people,
            aiw::commands::aiw_person_save,
            aiw::commands::aiw_person_forget,
