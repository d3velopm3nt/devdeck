...
function Work() {
  ...
  return (
    <div className="flex h-full flex-col">
      <PageHead
        title="Work"
        subtitle="Every work item in this space, and who is holding it."
        right={
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4">
        {a.allWork.length === 0 ? (
          <div className="py-10 text-center text-[12px] text-muted">
            Nothing here yet. Work items come from a feature — a bot&rsquo;s plan makes one, and
      ...
      <div className="shrink-0 border-t border-line px-5 py-2 text-[10.5px] text-faint">
        {open} open of {total}. Work items live in each feature&rsquo;s `work.md`, in the vault —
